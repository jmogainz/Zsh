...
alias llfo="sudo ~/OneDrive/Misc/system_libs_link_and_unlink/link_libs.sh --path ~/OneDrive/Misc/system_libs_for_afsim_mission; "

# ulfo = unlink libs from onedrive
alias ulfo="sudo ~/OneDrive/Misc/system_libs_link_and_unlink/unlink_libs.sh --path ~/OneDrive/Misc/system_libs_for_afsim_mission"
